...
public class InteractionController {
    ...
    public boolean injectEventSync(InputEvent event) throws Exception {
    ...
    public boolean touchDown(int x, int y) throws Exception {
